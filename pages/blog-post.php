	 ...
	 <div class="container">
	 	...
	 	<div class="posts col-md-9">
	 		...
	 		<div class="post-entry">
	 			...
	 			<div class="clearfix">
	 				<?php require MC_ROOT.'/parts/section/blog-single-slider.php' ?>
	 			</div><!-- /.clearfix -->
			...
			<?php require MC_ROOT.'/parts/section/blog-single-comments.php';?>

			<?php require MC_ROOT.'/parts/section/blog-single-reply.php';?>
