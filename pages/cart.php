<section id="cart-page" class="outer-top-xs">
    <div class="container">
        <!-- ========================================= CONTENT ========================================= -->
...
if($fn->ifLoggedInReturnAsMember(true)){
	...
	if(trim(mysqli_num_rows(mysqli_query($dbCon,"SELECT * FROM $tbl_name WHERE checked_out LIKE 0"))) > 0){
		$rows = mysqli_query($dbCon,"SELECT * FROM $tbl_name WHERE checked_out LIKE 0 ORDER BY id DESC");		
		$added_prices = array();
	...
	$items_in_cart = mysqli_query($dbCon,"SELECT * FROM $tbl_name WHERE checked_out LIKE 0 ORDER BY id DESC");		
	$num_rows = mysqli_num_rows($items_in_cart);
